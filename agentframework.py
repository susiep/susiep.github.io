...
class Person():                                         #Create the class called Person
    ...
    def getx(self):                                     #Use set and get property functions to safeguard the x,y variables
        return self._x
    ...
    def __str__(self):                                  
   #When an person is printed, return information about their position and no of apples
